function [minrho1, mat, minT] = OptimalLollipop(N)
%%% This function finds the lollipop graph of a given size that has 
...
for t = 1:N-3
    W(:,:,t) = Lollipop(N-t,t); %create lollipop graph of size N and tail size t
